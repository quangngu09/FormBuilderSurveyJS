  ...
  render(): React.JSX.Element {
    ...
    return this.props.disabled ? (
      ...
      <div ref={this.rootRef} className="sv-scroll__wrapper">
        <div
          className="sv-scroll__scroller sv-drag-target-skipped"
          onScroll={() => this.model.onScrollContainer()}
        >
          <div className="sv-scroll__container">{this.props.children}</div>
        </div>
        <div
          className="sv-scroll__scrollbar"
          onScroll={() => this.model.onScrollScrollbar()}
        >
          <div className="sv-scroll__scrollbar-sizer"></div>
        </div>
      </div>
    );
  }
...
ReactElementFactory.Instance.registerElement("svc-scroll", (props) => {
  return React.createElement(Scroll, props as IScrollComponentProps);
});
